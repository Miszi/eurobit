...
uint256 hashGenesisBlock("0x8d4677e7abf0bdf94b5b18bb7d54ce40aadbd97b33f59afe3c231243d0f829fe");
...
static int64 nTargetTimespan = 2 * 60 * 60; // EuroBit: 2 hours
static int64 nTargetSpacing = 60; // EuroBit: 60 seconds
*/
...
static int64 nTargetTimespan = 1 * 60 * 60; // eurobit: 2 hours
static int64 nTargetSpacing = 120; // eurobit: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eurobit miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "eurobit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x928f3c110b856cf39a37754f6a1cb0432d850e98f2b83079bde5b5a538e2b9fa");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "EuroBit founded 1/1/2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392824519;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 456295;

        if (fTestNet)
        {
            block.nTime    = 1392814800;             //test net not supported
            block.nNonce   = 342465;
        }
		...
		assert(block.hashMerkleRoot == uint256("0x28d9662d3f34c4d0a4b41047280394539a3e2ae0aec12fa20db1d87dcfc269f4"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // eurobitd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
